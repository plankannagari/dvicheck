...
## Migrations
- `V1`–`V6` exist. **`V7`** = `add_budget_goal` (`budget_amount` on `users`, Day 20). Next free version is **`V8`** — untouched Day 21.
...
🔄 Day 22 next — Spending trends chart, week-over-week sparkline on HomeScreen
