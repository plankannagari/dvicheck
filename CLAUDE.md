...
## Migrations
- `V1`–`V6` exist (`V6` = `push_token`). Next free version is **`V7`** — no migration was needed for Day 16, 17, 18, or 19 (all response-DTO/service-layer/mobile-only changes, no schema change).
...
🔄 Day 20 next — Monthly spending report, budget goal setting
