...
## Migrations
- `V1`–`V6` exist. **`V7`** = `add_budget_goal` (`budget_amount` on `users`, Day 20). Next free version is **`V8`**.
...
🔄 Day 21 next — Bill type classification improvements, manual store name correction
