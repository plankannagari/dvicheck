...
## Migrations
- `V1`–`V6` exist. **`V7`** = `add_budget_goal` (`budget_amount` on `users`, Day 20). **`V8`** = `add_item_feedback` (`item_feedback` table, Day 23). Next free version is **`V9`**.
...
🔄 Day 24 next — Budget alert notifications, threshold warning when approaching budget
